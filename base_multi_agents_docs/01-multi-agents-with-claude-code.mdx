...
Under the hood, the agent spawns sub-agents to work on git worktrees. This guarantees isolation:
...
**Next:** [Part 2 — Writer + reviewer sub-agent loop](./02-writer-reviewer-loop)
