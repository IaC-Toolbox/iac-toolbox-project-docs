      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <p className="text-sm font-medium text-primary mb-2 uppercase tracking-wide">{SECTION_LABEL}</p>
          ...
          <div className="rounded-lg border border-border bg-card p-8 md:p-12 relative">
            ...
            <blockquote className="relative">
              <p className="text-lg md:text-xl text-foreground leading-relaxed mb-6">{TESTIMONIAL_TEXT}</p>
