    ...
    <section className={`py-16 md:py-24 ${sectionClassnames}`}>
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight md:text-4xl mb-4 text-balance">{SECTION_TITLE}</h2>

          <p className="text-lg text-muted-foreground mb-8 text-pretty max-w-xl mx-auto">{SECTION_DESCRIPTION}</p>
