...
const SECTION_DESCRIPTION = "From zero to production-ready infrastructure. Each tutorial builds on the previous one."
          ...
          {tutorials.map((tutorial, index) => (
            <Card key={tutorial.title} className="group hover:border-primary/50 transition-colors">
              <CardHeader className="pb-2">
                ...
                <CardTitle className="text-base group-hover:text-primary transition-colors">{tutorial.title}</CardTitle>
              </CardHeader>
              <CardContent>
