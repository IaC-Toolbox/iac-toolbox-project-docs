...
const faqs = [
  ...
  },
  {
    ...
    detail:
      'Start with a basic setup and evolve toward security, compliance, and scale when you are ready.',
  },
  {
    ...
    detail:
      'These tutorials assume basic developer knowledge and explain AWS and Terraform concepts as you go.',
  },
  {
    ...
    detail:
      'We optimize for cost-efficiency without sacrificing the patterns you will need as you scale.',
  },
  {
  ...
  },
  {
    ...
    detail:
      'By the end, you will have production-ready AWS infrastructure managed entirely with Terraform.',
  },
];
