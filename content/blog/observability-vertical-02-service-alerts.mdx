...
resource "grafana_folder" "my_service" {
  title = "my_service_alerts"
}
```

Grafana works by placing all alerts into a single folder regardless of their origin, so we create folder above.
