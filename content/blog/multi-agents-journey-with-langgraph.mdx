...
Being rigorous in experimentation is another learning we can extract from this experience. In the future, we will timebox it harder, decide upfront what evidence would change our minds, check in with the teams building the frameworks more regularly. Most importantly, assume those frameworks are getting materially better while we are working. The conceptual lessons here are real and we use them every day.
