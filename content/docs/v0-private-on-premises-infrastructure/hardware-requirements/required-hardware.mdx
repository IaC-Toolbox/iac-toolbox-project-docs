...
![Raspberry Pi 4B](./images/raspberry_pi_4b_and_sd_card.jpg)
...
![Raspberry Pi 4B with microSD Card](./images/raspberry_pi_4b_and_sd_card_profile.jpg)

Once you have your microSD card flashed with the OS, simply insert it into the Pi:

![SD Card Connected to Raspberry Pi](./images/raspberry_pi_4b_and_sd_card_connected.jpg)
...
![Raspberry Pi in Case - Opened](./images/raspberry_pi_and_case_opened.jpg)

Here's what it looks like when assembled and closed:

![Raspberry Pi in Case - Closed](./images/raspberry_pi_in_the_case_closed.jpg)
...
![Raspberry Pi Powered On](./images/raspberry_pi_powered_on_lights_on.jpg)
