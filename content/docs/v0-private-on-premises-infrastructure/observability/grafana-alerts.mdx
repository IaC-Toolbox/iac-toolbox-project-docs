...
![Grafana Alert Rules](./images/grafana-alert-rules.png)
...
![CPU Alert Firing](./images/cpu_alert_firing.png)
...
![Grafana Alert Failed Email Delivery](./images/grafana-alert-failed-email-delivery.png)
...
![Grafana Dashboard Hardware Temperature Monitor](./images/grafana-dashboad-hardware-temperature-monitor.png)
